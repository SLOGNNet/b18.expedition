...
public class DriverEntityTest {
    ...
    public void test() {
        ...
        Address driverAddress = Address.builder()
                ...
                .streetAddress1("addressName-1")
                .streetAddress2("addressName-1")
                .city("addressName-1")
                .addressPhone("addressName-1")
                .state("addressName-1")
                .zip("addressName-1")
                .addressFax("addressName-1")
                .addressPhoneExtension("addressName-1")
                .addressFaxExtension("addressName-1")
                .addressLatitude(1)
                .addressLongitude(1)
                .build();
        ...
        License driverLicense = License.builder()
                ...
                .licenseRestrictions("licenseEndorsements-1")
                .build();
        ...
        Address driverAddress2 = Address.builder()
                .addressId(2)
                .addressName("addressName-2")
                .streetAddress1("addressName-2")
                .streetAddress2("addressName-2")
                .city("addressName-2")
                .addressPhone("addressName-2")
                .state("addressName-2")
                .zip("addressName-2")
                .addressFax("addressName-2")
                .addressPhoneExtension("addressName-2")
                .addressFaxExtension("addressName-2")
                .addressLatitude(2)
                .addressLongitude(2)
                .build();
        ...
        License driverLicense2 = License.builder()
                ...
                .licenseRestrictions("licenseEndorsements-2")
                .build();
