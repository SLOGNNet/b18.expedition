...
public class DriverEntityTest {
    ...
    public void test() {
        ...
        Address driverAddress = Address.builder()
                ...
                .city("city-1")
                .addressPhone("addressPhone-1")
                .state("state-1")
                .zip("zip-1")
                .addressFax("addressFax-1")
                .addressPhoneExtension("addressPhoneExtension-1")
                .addressFaxExtension("addressFaxExtension-1")
                .addressLatitude(1)
                .addressLongitude(1)
                .build();
        ...
        Address driverAddress2 = Address.builder()
                ...
                .city("city-2")
                .addressPhone("addressPhone-2")
                .state("state-2")
                .zip("zip-2")
                .addressFax("addressFax-2")
                .addressPhoneExtension("addressPhoneExtension-2")
                .addressFaxExtension("addressFaxExtension-2")
                .addressLatitude(2)
                .addressLongitude(2)
                .build();
