...
@Singleton
public class EquipmentRepositoryV1 {
    private CassandraSession session;

    @Inject
    public EquipmentRepositoryV1(CassandraSession session, ReadSide readSide) {
        ...
        return session
                ...
                .thenApply(resultSet -> {
                            List<EquipmentSummary> resultList = resultSet.all().stream()
                                    .map(EquipmentRepositoryV1::convertEquipmentSummary)
